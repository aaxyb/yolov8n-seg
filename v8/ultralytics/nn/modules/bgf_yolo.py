...
from einops import rearrange
from timm.models.hgnet import ConvBNAct
from torch import Tensor
from typing import Tuple
import torch.nn.functional as F
from ultralytics.nn.modules import SPP, RepConv
...
class BasicBlock_3x3_Reverse(nn.Module):
    def __init__(self,
        ...
        self.conv1 = ConvBNAct(ch_hidden, ch_out, 3, )
        self.conv2 = RepConv(ch_in, ch_hidden, 3,  )
...
class CSPStage(nn.Module):
    def __init__(self,
        ...
        for i in range(n):
            ...
            if i == (n - 1) // 2 and spp:
                self.convs.add_module(
                    'spp', SPP(ch_mid * 4, ch_mid, 1, [5, 9, 13], ))
            next_ch_in = ch_mid
